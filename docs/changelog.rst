...
* Significant changes to on-disk database. Server operators need to manually delete old DB,
...
* We now require Bitcoin Core to have `txospenderindex=1` (added in Bitcoin Core 31)
  ...
  - the ElectrumX db uses around 122 GiB (roughly same for both of e-x 1.x and 2.0),
