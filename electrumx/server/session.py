...
class SessionManager:
    ...
    async def rpc_debug_memusage_list_all_objects(self, limit):
    ...
    async def rpc_debug_memusage_get_random_backref_chain(self, objtype):
        # note: warning! very slow! and it blocks the server.
        # to convert to image:
